...
from the_olympus.views import CreateInvitation, landing, user_dashboard, ProfilesListView, delete_user, change_plan
urlpatterns = [

    path('', landing, name='landing'),
    path('dashboard/', user_dashboard, name='dashboard'),
    path('change-plan/', change_plan, name='change_plan'),
